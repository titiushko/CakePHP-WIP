...
echo $this->element(
	'ver', array(
		...
		'campos' => array(
			'dui' => array('value' => $mesero['Mesero']['dui'], 'disabled' => TRUE, 'label' => array('text' => 'DUI', 'class' => 'col-lg-3 control-label')),
			'nombres' => array('value' => $mesero['Mesero']['nombres'], 'disabled' => TRUE),
			'apellidos' => array('value' => $mesero['Mesero']['apellidos'], 'disabled' => TRUE),
			'telefono' => array('value' => $mesero['Mesero']['telefono'], 'disabled' => TRUE, 'label' => array('text' => 'Teléfono', 'class' => 'col-lg-3 control-label'))
		),
